...
class LHEParticle(object):
    ...
    def daughters(self):
		...
		self.event.particles.daughters =  []
		particles = self.event.particles
		for i in range(len(particles)):
			if particles.mother1 !=0:
				particles[int(partciles.mother1)-1].daughters.append(i)
			if particles.mother2 !=0:
				particles[int(partciles.mother2)-1].daughters.append(i)										  
